...
class TestConfig:
    ...
    def test_config_with_custom_values(self) -> None:
        ...
        config = Config(
            total_samples=1000, min_quality_score=8.0, max_template_overlap=0.03
        )
...
class TestDomainConfig:
    ...
    def test_domain_content_types(self) -> None:
...
class TestBiasTypesConfig:
    ...
    def test_bias_types_structure(self) -> None:
    ...
    def test_bias_patterns_structure(self) -> None:
        ...
        for bias_type, bias_config in bias_configs.items():
            ...
            for epoch in TimeEpoch:
                assert (
                    epoch in patterns
                ), f"Missing epoch {epoch} in bias type {bias_type}"
