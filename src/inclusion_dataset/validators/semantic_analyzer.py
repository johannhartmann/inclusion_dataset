...
from ..config.constants import METRICS, LIMITS, VALIDATION
from .exceptions import SemanticAnalysisError, InsufficientDataError
...
class SemanticAnalyzer:
    ...
    def measure_semantic_spread(self, instructions: List[str], 
                               max_clusters: int = None) -> Dict[str, Any]:
        ...
        """
        if not instructions:
            raise InsufficientDataError("No instructions provided for semantic analysis")
    ...
    def _perform_clustering(self, X, instructions: List[str], 
    ...
    def _calculate_similarity_metrics(self, X) -> Dict[str, float]:
    ...
    def validate_semantic_diversity(self, instructions: List[str], 
                                   min_distance: float = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "message": (
                    "Semantic diversity requirements met" if meets_requirement 
