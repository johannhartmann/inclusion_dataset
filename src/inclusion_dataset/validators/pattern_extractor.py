...
from ..config.constants import PATTERNS, METRICS
...
class PatternExtractor:
    ...
    @staticmethod
    def find_prefix_patterns(instructions: List[str], 
                           min_length: int = None,
                           max_length: int = None,
                           min_frequency_ratio: float = None) -> Dict[str, List[str]]:
    ...
    @staticmethod
    def find_suffix_patterns(instructions: List[str],
                           min_length: int = None,
                           max_length: int = None, 
                           min_frequency_ratio: float = None) -> Dict[str, List[str]]:
    ...
    @staticmethod
    def find_common_substrings(text1: str, text2: str, min_length: int = None) -> List[str]:
        ...
        """
        min_length = min_length or PATTERNS.MIN_PATTERN_LENGTH
        common_parts = []
