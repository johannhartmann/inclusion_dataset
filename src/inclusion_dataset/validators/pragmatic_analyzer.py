...
from .exceptions import InsufficientDataError, PragmaticAnalysisError
...
class PragmaticAnalyzer:
    ...
    def validate_pragmatic_functions(self, instructions: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "meets_minimum_requirement": len(function_counts)
                >= PATTERNS.MIN_PRAGMATIC_FUNCTIONS,
            }
    ...
    def _instruction_matches_function(
        self, instruction: str, patterns: List[str]
    ) -> bool:
    ...
    def _calculate_diversity_metrics(
        self, function_counts: Dict[str, int], instructions: List[str]
    ) -> Dict[str, float]:
